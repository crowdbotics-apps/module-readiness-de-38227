...
## Project Structure
    ...
    ├── module_readiness_de_38227  # Django project configurations
...
1. Clone this repo and `cd module_readiness_de_38227`
...
2. Clone this repo and `cd module_readiness_de_38227`
